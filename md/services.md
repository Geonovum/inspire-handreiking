...
In het <a href="https://github.com/Geonovum/testbed-spatial-APIs" target="_blank">Geonovum Testbed Spatial data API's</a> is ervaring opgedaan met 5 verschillende aspecten van implementatie en gebruik van OGC API's. Daarnaast zijn in de <a href="https://geonovum.github.io/OAPIF-PDOK-INSPIRE/" target="_blank">Handreiking OGC API Features conform INSPIRE</a> de eerste bevindingen voor het maken van een OAPIF conform INSPIRE beschreven.
