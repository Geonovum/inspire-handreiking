...
## Service validatie
Validatie is een mechanisme om te controleren of een service aan de specificaties voldoet. Het is een onmisbaar hulpmiddel om tot een correcte implementatie te komen. Er zijn verschillende validatietools beschikbaar om (verschillende onderdelen van) INSPIRE services te valideren. In het hoofdstuk [validatie](#validatie) is dit beschreven.
