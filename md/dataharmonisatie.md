...
|<a href="https://knowledge-base.inspire.ec.europa.eu/publications/inspire-data-specifications-base-models-generic-network-model_en" target="_blank">INSPIRE Base model - Generic Network Model (GNM)</a> |1.0rc3|2013-04-05|Algemeen basismodel voor netwerken zoals bijvoorbeeld vervoersnetwerken|
...
|<a href="https://knowledge-base.inspire.ec.europa.eu/evolution/good-practice-library_en" target="_blank">Good Practice Library</a>|||Hier worden good practises beschreven m.b.t. de implementatie van INSPIRE, m.b.t. tools en technieken die nuttig zijn voor de implementatie van INSPIRE of m.b.t. technologieën die voortbouwen op INSPIRE|
...
- <a href="https://wetransform.to/halestudio/" target="_blank">HALE</a>; RVO heeft voor het gebruik van HALE een beknopte <a href="media/Handleiding_Gebruik_HALE_voor_INSPIRE_dataharmonisatie_120618.pdf" target="_blank">handleiding</a> geschreven;
...
- <a href="https://www.snowflake.com/en/" target="_blank">GO Publisher</a>;
