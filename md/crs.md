...
Voor Nederlandse 2D data wordt geadviseerd te publiceren met ETRS89 en daarnaast RD.
Voor Nederlandse 3D data wordt geadviseerd te publiceren met ETRS89 + EVRS: (EPSG-code: 7409) en daarnaast RD + NAP (EPSG-code: 7415)
Wanneer de hoogte nauwkeurigheid van de data beter is dan 5 cm, is het noodzakelijk dat er een coördinaattransformatie plaatsvindt van NAP naar EVRS. Anders kunnen de hoogtes gelijk gesteld worden.

Omdat CRS-en gekoppeld zijn aan tectonische platen veranderen ze in de tijd. Daarom wordt er gesproken van zogenaamde
<a href="https://docs.geostandaarden.nl/crs/crs/#realisaties-van-etrs89-en-evrs" target="_blank">realisaties</a>

Wanneer er een nieuwe realisatie wordt vastgesteld veranderen ook de de codes die bij de CRS-en horen.  
