...
| **Specificatie distributieformaat**  				| MD_Metadata.distributionInfo> MD_Distribution.distributionFormat> MD_Format.specification| Ja | Het element invullen is verplicht als de dataset een  INSPIRE dataset is. | xlink:href=https://github.com/INSPIRE-MIF/technical-guidelines/blob/main/data/hy Dataspecificatie hydrografie|
